...
const CommentSection = ({ postId }) => {
    ...
    return (
        <div className='max-w-2xl mx-auto w-full p-3'>
            ...
            {currentUser && (
                <form className='border border-teal-300 rounded-lg p-3 ' onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-between items-center mt-5">
                        ...
                        <Button type='submit' outline className="px-5 py-2 rounded-lg font-semibold border border-teal-500 text-teal-500 hover:bg-teal-500 hover:text-white transition">Submit</Button>
                    </div>
                    {commentError && (
            ...
            {comments.length === 0 ? (
                ...
                <>
                    ...
                    {comments.map(comment => (
                        <Comments key={comment._id} comment={comment} onLike={handleLikes} onEdit={handleEdit} onDelete={(commentId) => { setShowModal(true); setCommentToDelete(commentId); }} />
                    ))}
                </>
            )}
