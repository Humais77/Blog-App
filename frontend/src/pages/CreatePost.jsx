...
const CreatePost = () => {
  ...
  const handleUploadImagee = async () => {
    try {
      if (!file) {
        setImageUploadingerror('Please select a file');
        return;
      }
  ...
  return (
    <div className='p-3 max-w-3xl mx-auto min-h-screen'>
      ...
      <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
            ...
            <TextInput
              ...
              onBlur={() => {
                if (!customCategory.trim()) {
                  setIsCustom(false); // go back to dropdown if empty
                }
              }}
            />
          )}
        ...
        <Button type='submit' className='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white'>
          Publish
        </Button>
